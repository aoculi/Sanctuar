...
export const bookmarks = sqliteTable('bookmarks', {
    ...
    vaultId: text('vault_id').notNull().references(() => vaults.vaultId, { onDelete: 'cascade' }),
...
export const tags = sqliteTable('tags', {
    ...
    primaryKey({ columns: [table.tagId, table.vaultId] }),
]);
...
export const bookmarkTags = sqliteTable('bookmark_tags', {
    vaultId: text('vault_id').notNull().references(() => vaults.vaultId, { onDelete: 'cascade' }),
    itemId: text('item_id').notNull().references(() => bookmarks.itemId, { onDelete: 'cascade' }),
