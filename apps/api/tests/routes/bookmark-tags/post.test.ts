...
const bookmarkRoutes = (await import('../../../src/routes/bookmark.routes')).default;
const tagRoutes = (await import('../../../src/routes/tag.routes')).default;
const bookmarkTagRoutes = (await import('../../../src/routes/bookmark-tag.routes')).default;
const { clearRateLimits } = await import('../../../src/middleware/rate-limit.middleware');
...
describe('POST /bookmark-tags', () => {
    ...
    beforeEach(async () => {
        ...
        const bookmarkCiphertext = Buffer.from('encrypted-bookmark-content').toString('base64');
        const bookmarkNonceWrap = Buffer.alloc(24, 2).toString('base64');
        const bookmarkDekWrapped = Buffer.alloc(32, 3).toString('base64');
        const bookmarkSize = Buffer.from(bookmarkNonce, 'base64').length +
        ...
        const tagCiphertext = Buffer.from('encrypted-tag-content').toString('base64');
        const tagSize = Buffer.from(tagNonce, 'base64').length + Buffer.from(tagCiphertext, 'base64').length;
    ...
    it('returns 404 when tag is soft-deleted', async () => {
        ...
        const tagCiphertext = Buffer.from('encrypted-tag-to-delete').toString('base64');
        const tagSize = Buffer.from(tagNonce, 'base64').length + Buffer.from(tagCiphertext, 'base64').length;
    ...
    it('supports multiple tags per bookmark', async () => {
        ...
        const tag2Ciphertext = Buffer.from('encrypted-tag2-content').toString('base64');
        const tag2Size = Buffer.from(tag2Nonce, 'base64').length + Buffer.from(tag2Ciphertext, 'base64').length;
        ...
        const tag3Ciphertext = Buffer.from('encrypted-tag3-content').toString('base64');
        const tag3Size = Buffer.from(tag3Nonce, 'base64').length + Buffer.from(tag3Ciphertext, 'base64').length;
    ...
    it('supports multiple bookmarks per tag', async () => {
        ...
        const bookmark2Ciphertext = Buffer.from('encrypted-bookmark2-content').toString('base64');
        const bookmark2NonceWrap = Buffer.alloc(24, 13).toString('base64');
        const bookmark2DekWrapped = Buffer.alloc(32, 14).toString('base64');
        const bookmark2Size = Buffer.from(bookmark2Nonce, 'base64').length +
        ...
        const bookmark3Ciphertext = Buffer.from('encrypted-bookmark3-content').toString('base64');
        const bookmark3NonceWrap = Buffer.alloc(24, 16).toString('base64');
        const bookmark3DekWrapped = Buffer.alloc(32, 17).toString('base64');
        const bookmark3Size = Buffer.from(bookmark3Nonce, 'base64').length +
