...
describe('POST /user/wmk', () => {
    ...
    it('should update WMK if uploaded again', async () => {
        ...
        const newWmk = 'TmV3IDI0IGJ5dGUgbm9uY2Vob3BlISFOZXcgMzIgYnl0ZXMgb2YgY2lwaGVydGV4dCEh';
        const res = await client.user.wmk.$post(
            {
                json: {
                    wrapped_mk: newWmk,
    ...
    it('should allow different users to have different WMKs', async () => {
        ...
        const bobWmk = 'Qm9iIDI0IGJ5dGUgbm9uY2Vob3BlISFCb2IgMzIgYnl0ZXMgb2YgY2lwaGVydGV4dCEh';
        await client.user.wmk.$post(
            {
                json: {
                    wrapped_mk: bobWmk,
